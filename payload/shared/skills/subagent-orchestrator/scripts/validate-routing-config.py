...
ROLE_INSTRUCTION_SHA256 = {
    "en": {
        "evidence_tester": "ad77e3636dbe98542ebe0defbf42fd2f30177e560b938a04d87aa9f2286e0490",
        "boundary_mapper": "5f38f3ef20bcc4cd4709ea89102b49bfcc2753a0493fcf6188130348c5161eec",
        "risk_reviewer": "b9b50eeb7a626aedeb417a41db9ea104d055ac283aaa568e67990a7a51991971",
        "risk_reviewer_max": "9d8c99a1d04966a7d433883d7357859d97e574f468e8e581cb954c0bcabd9a0f",
    },
    "zh": {
        "evidence_tester": "f3d8aeee34c2035ba77b644cc9f9c038abb843dfc880b79eb0574799c795b650",
        "boundary_mapper": "84849fb2e1281c085d3cd361927f68c545da76dacb83b33b4d08044d5a12ce68",
        "risk_reviewer": "d3f4773aa55571b59f4eeb1cc99b44a76a75bda5dd0182d40e5c6ee2d5e64b3c",
        "risk_reviewer_max": "909c7898b8a3b95a88f3a54d7fe908dd36afa3a420afe581e7837666b3e82353",
    },
}
ROLE_MARKERS = {
    "en": {
...
GLOBAL_POLICY_MARKERS = {
    "en": {
        "## Subagents and parallelism": (
            ...
            "Use `$subagent-orchestrator` only when",
            "Keep small, sequential, ambiguous, shared-state, and coordination-heavy work with the primary",
            "primary retains authorization, scope, integration, finding adjudication, and final acceptance",
            "Children are leaves: start one",
            "at most one active writer with no overlapping write scopes",
            "use installed model and effort settings",
            "Read the Skill for role selection, handoffs, later waves, reviews, and evidence-based closure",
        ),
    },
    "zh": {
        "## 子代理与并行": (
            ...
            "小型、顺序性、含糊、共享状态或协调成本高的工作由主代理完成",
            "主代理保留授权、范围、整合、审查发现裁决和最终验收权",
            "子代理必须是叶子：先启动一个",
            "最多保留一个活动写入者，写入范围不得重叠",
            "已安装的模型与推理设置",
            "角色选择、交接、后续波次、审查和基于证据的收尾由 Skill 规定",
        ),
    },
}
POLICY_MARKERS = {
